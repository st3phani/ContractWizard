...
- July 30, 2025. **BACKUP AUTOMAT MOVED TO DATA MANAGEMENT** - Moved "Backup Automat" setting from "Setări Sistem" section to "Gestionare Date" section in Settings page for better logical organization. Added separator between backup setting and export/import buttons.
