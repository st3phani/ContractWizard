...
- July 30, 2025. **REMOVED AUTO_BACKUP FROM SYSTEM_SETTINGS** - Completely eliminated auto_backup field from system_settings table and all related code. Removed from database schema, MemStorage, DatabaseStorage, and Settings frontend page. Simplified system settings to only include language, currency, and date format configuration.
