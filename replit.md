...
- July 22, 2025. Fixed PDF generation completely - implemented reliable jsPDF solution with proper text wrapping, bold formatting support, and automatic page breaks for perfect document layout. Text now fits perfectly within page margins with correct word wrapping for mixed bold/normal text. Moved PDF generation logic to utils/pdfGenerator.ts for better code organization.
