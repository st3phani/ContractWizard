...
- July 30, 2025. **SYSTEM SETTINGS KEY-VALUE RESTRUCTURE** - Restructured system_settings table with key-value architecture: config_id, path, value, updated_at columns. Migrated to rows: system_language, system_currency, system_dateFormat, system_autoBackup. Updated storage logic to convert between key-value and object format for backward compatibility. Added formatted timestamp display (YYYY-MM-DD HH:MM:SS format).
